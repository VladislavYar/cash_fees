...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_first_name', models.CharField(db_comment='Имя', help_text='Имя', max_length=150, verbose_name='Имя')),
                ('user_last_name', models.CharField(db_comment='Фамилия', help_text='Фамилия', max_length=150, verbose_name='Фамилия')),
                ...
                ('status', models.BooleanField(db_comment='Статус платежа', default=False, help_text='Статус платежа', verbose_name='Статус платежа')),
            ],
            options={
                'verbose_name': 'Платёж',
